    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable WakelockApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.wakelock_platform_interface.WakelockApi.toggle", getCodec());
        if (api != null) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.wakelock_platform_interface.WakelockApi.isEnabled", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
