...
abstract class TestWakelockApi {
  ...
  static void setup(TestWakelockApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.wakelock_platform_interface.WakelockApi.toggle', codec,
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.wakelock_platform_interface.WakelockApi.toggle was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final ToggleMessage? arg_msg = (args[0] as ToggleMessage?);
          assert(arg_msg != null,
              'Argument for dev.flutter.pigeon.wakelock_platform_interface.WakelockApi.toggle was null, expected non-null ToggleMessage.');
          api.toggle(arg_msg!);
          return <Object?>[];
        });
      }
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.wakelock_platform_interface.WakelockApi.isEnabled', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, null);
      } else {
